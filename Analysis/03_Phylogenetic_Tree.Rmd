...
load("./preprocessing_phyloseq/raw_physeq.RData")
raw_physeq
```
...
write(asv_seq_fasta, 
      file = "./phylo_tree/preprocessed_ASVs.fasta")
```
...
load("./preprocessing_phyloseq/Data/NEW_raw_physeq.RData")
NEW_raw_physeq

unrooted_tree <- read.tree("./phylogenetic_analysis/Data/ASVs_unrooted.tree")
unrooted_tree
...
merged_phytree <- merge_phyloseq(midpoint_rooted_tree, raw_physeq)

final_phy_tree <- ggtree(merged_phytree) + 
  geom_tippoint(mapping = aes(color = Kingdom))

save(merged_phytree, file = "./phylogenetic_analysis/Data/merged_phytree_preprocessed_physeq.RData")

save("final_phy_tree",
     file = "./phylogenetic_analysis/Data/phytree_preprocessed_physeq.RData")
```
