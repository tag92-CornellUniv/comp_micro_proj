...
The horizon nmds plot has a low stress valu, around 0.05, and is indicative of a good fit for the represented variable and that horizon may cause the variation observed. NMDS and PCoA plots are also similar, so this is a good sign. 

There isn't a strong correlation with burn year, which completely goes against the hypothesis. Data points cluster more based on horizon, and this can be observed within plots colored by horizon as datapoints.
